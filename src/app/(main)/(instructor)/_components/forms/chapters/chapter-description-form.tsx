...
interface CourseSectionDescriptionFormProps {
  courseId: string;
  sectionId: string;
  initialData: {
    description: string;
...
const CourseSectionDescriptionForm = ({ courseId, initialData, sectionId }: CourseSectionDescriptionFormProps) => {
...
export default CourseSectionDescriptionForm;
