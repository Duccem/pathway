...
interface CourseSectionTitleFormProps {
  courseId: string;
  sectionId: string;
  initialData: {
    title: string;
...
const CourseSectionTitleForm = ({ courseId, initialData, sectionId }: CourseSectionTitleFormProps) => {
...
export default CourseSectionTitleForm;
